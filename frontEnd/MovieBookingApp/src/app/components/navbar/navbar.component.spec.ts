...
//this is a test suite for the 'NavbarComponent' ,and all the tests for this component are written within this 'describe' block
...
//configures the testing module and set up the necessary testing modules and components    
    await TestBed.configureTestingModule({
      ...
      declarations: [ NavbarComponent ], //declarations:available for testing
